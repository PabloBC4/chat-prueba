...
const app = express();
app.use(cors()); // Esto evita bloqueos de seguridad al conectar el frontend

// 2. Creamos el servidor HTTP
const server = http.createServer(app);

// 3. Configuramos los Sockets (El tiempo real)
const io = new Server(server, {
  cors: {
    origin: "*", // Permite conexiones desde cualquier frontend (ideal para desarrollo)
    methods: ["GET", "POST"]
  }
});
...
// 5. Encendemos el motor en el puerto 3000
server.listen(3000, () => {
